...
# Build AI Consultant Portfolio

## Desired Outcome

By October 31, 2026, establish a credible AI consulting portfolio that combines recognized credentials, working demonstrations, documented case studies, governance capability, public professional positioning, and a clear consulting offer.

## Success Criteria

- [ ] Current credentials, training, badges, and incomplete courses are inventoried.
- [ ] Microsoft AI Transformation Leader (AB-731) is earned.
...
### Days 1–30 — Establish the Business-Transformation Foundation

**Credential**

- Prepare for Microsoft Certified: AI Transformation Leader (AB-731).
- Use the official study guide and practice assessment.
- Do not add another exam until the study schedule and exam date are recorded.
...
- Earn Google Cloud Generative AI Leader.
- Begin AWS Certified AI Practitioner preparation.
...
- Create a discovery-call questionnaire.
- Create a workflow-audit template.
- Create a proposal and statement-of-work template.
- Define three productized offers: assessment, implementation, and governance/optimization.

### Days 61–90 — Prove Implementation and Governance

**Credential**

- Complete AWS Certified AI Practitioner unless the market-demand review justifies replacing it.
- Begin Microsoft AI Agent Builder Associate preparation only after two working agent builds exist.
- Prepare an AIGP business case; do not purchase until the cost, target opportunities, and expected return are documented.

**Build while learning**

- Working agent demonstration using tools, knowledge sources, approvals, logs, and fallback behavior.
...
- [ ] Official credential source verified.
...
- [ ] At least one current market signal recorded.
...
- [ ] Security and governance risks reviewed.
...
6. Human approval and fallback points.
...
- Collecting certificates without portfolio evidence.
