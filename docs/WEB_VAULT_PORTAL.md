...
| `/tasks`, `/businesses`, `/growth`, `/intelligence`, `/agents`, `/resources`, `/people`, `/reviews`, `/sops`, `/archive`, `/daily-brief`, `/portfolio`, `/prompts`, `/resources/review` | Advanced / More — capabilities kept, not primary nav |
